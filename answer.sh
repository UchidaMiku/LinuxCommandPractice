...
$ pwd
/home/codespace/LinuxCommandPractice
...
$ ls -l
drwxrwxrwx+ 2 codespace codespace 4096 May  8 12:44 LinuxCommandPractice
-rw-rw-rw-  1 codespace root        22 May  8 09:22 README.md
drwxrwxrwx+ 3 codespace codespace 4096 May  8 09:39 practice_dir_1
...
# 11. `LinuxCommandPractice`ディレクトリ内から**移動せずに**、`practice_dir_1`内に`practice_dir_2`ディレクトリが作成されていることを確認(表示)してください。**但し、相対パスを使用してください。**
 ls -l
drwxrwxrwx+ 2 codespace codespace 4096 May  9 02:00 practice_dir_1
drwxrwxrwx+ 2 codespace codespace 4096 May  9 01:59 practice_dir_2
...
# 13 `practice_dir_2`に移動してください。**但し、相対パスを使用してください。**
 $ cd ./practice_dir_1 $ cd ./practice_dir_2
...
echo "I'm goot at Linux commands!"
